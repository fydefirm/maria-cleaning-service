...
app.http("contact", {
  ...
  handler: async (request, context) => {
    ...
    try {
      ...
      // Destructure the properties into variables
      ...
      if (!name || !email || !phone || !service)
        return {
          status: 400,
          body: "Missing required fields: name, email, phone, and service are required",
        };
...
╚═══════════════════════════════════════════════════════╝
    ...
    //return { body: `Hello, world!` }; // Return response
  },
});
